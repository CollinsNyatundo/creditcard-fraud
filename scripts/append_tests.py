"""Helper script: appends new tests to test_predict_endpoint.py."""
import os
...
with open(r"d:\Projects\ai-ml\creditcard-fraud\tests\unit\test_predict_endpoint.py", "a", encoding="utf-8") as f:
    f.write(new_tests)

print("Done: appended calibrated model test and latency test.")
