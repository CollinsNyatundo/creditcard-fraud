...
Subtitle: Baseline vs Calibrated + Optimized LightGBM Model - Production-Grade ML with Strict Temporal Validation

### Grid Structure

| Criterion | Baseline Model | Calibrated + Optimized Model | Target | Status |
|-----------|---------------|----------------------------|--------|--------|
| F1-Score | 0.8041 | 0.8041 | > 0.85 | NEAR TARGET |
| Precision | 0.8667 | 0.8667 | > 0.90 | NEAR TARGET |
...
| 95th Percentile Latency | 3.63 ms | 1.41 ms | < 10.00 ms | PASS |
| 99th Percentile Latency | 7.55 ms | 1.79 ms | - | PASS |

### Supporting Sections (Dense Modules)

Panel A: Statistical Rigor
- Bootstrap F1 95% CI: [0.7073, 0.8833]
- Hypothesis p-value: 0.9565
...
- 72 total features x 4 families
...
- Ours: Strict chronological, no leakage -> F1 0.8041 (realistic)
...
- Side-by-side metric bars showing baseline vs calibrated/optimized values
- Highlight the latency improvement and AUPRC gain as key outcomes
