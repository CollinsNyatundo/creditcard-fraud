...
## Main Topic
An enterprise-grade, containerized ML pipeline for real-time credit card fraud detection, built on the Kaggle ULB dataset with strictly chronological splits, latency-constrained LightGBM optimization, and rigorous statistical validation.
...
3. The performance trade-offs and business impact of the optimized model vs baseline
...
- "F1-Score: 0.8478" (near >0.85 target), "Precision: 0.9750" (passes >0.90), "Recall: 0.7500" (maintains baseline)
- "Mean Latency: 3.03 ms", "95th Percentile Latency: 8.89 ms" (passes <10ms SLA)
- "Bootstrap 95% CI: [0.7593, 0.9195]", "p-value: 0.1501"
- "Statistical power: 24.8%" at current N_fraud=52, needs "N_fraud=325" for 80% power
- "72 total features" across 4 families: Temporal, Rolling Behavior, Interaction, Spending Anomalies
...
1. **comparison-matrix + corporate-memphis** (Recommended): Multi-factor comparison of Baseline vs Optimized across metrics, methodology, and business impact; clean flat vector style suits enterprise/production context.
